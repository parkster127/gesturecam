...
from gesturecam.settings import SettingsManager, get_settings
...
class AppController:
    ...
    def __init__(self):
        ...
        self._on_camera_update: Callable | None = None
        self._on_gesture_update: Callable | None = None
        self._on_zoom_update: Callable | None = None
